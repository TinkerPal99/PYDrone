...
## @package init
#
# <h4>Documentation for this initializer <u>autonmousDrive.py</u>.</h4>
#
# <p>
# <h5><i>Zweck</i>:</h5>Ausweichendes Fahren des Wagens, Vermeidung von Zusammenstößen, Versuch der Einbindung des OOP PiTank.py <br>
# <h5><i>Inhalt</i>:</h5>
# <p>
# <br><br>
...
# _Setup_________________________________________________________________________________________________________________
...
# __Setting Object_______________________________________________________________________________________________________
...
# __Start_of_Main________________________________________________________________________________________________________
try:
    while True:
        print("Try")
